...
class PopViewController: UITableViewController {
    ...
    var dataArray: [Array<String>] {
        let array = [["发起群聊", "ap_group_talk"], ["添加朋友", "ap_add_friend"], ["扫一扫", "ap_scan"], ["收钱", "ap_qrcode"]]
        return array
    }
    ...
    private func configTabelView() {
        ...
        let tableViewH: CGFloat = tableView.rowHeight * CGFloat(dataArray.count)
        
        // 设置tableView相关属性
        preferredContentSize = CGSize(width: 150, height: tableViewH)
